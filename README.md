ATTIVITÀ SVOLTE DA CIASCUN MEMBRO:
	...
	STEFAN:
	main, funzione get reading e operator <<, funzioni aggiuntive 

	DIEGO:
	generalizzazione classe myVector, scheletro finale, lettura, misura, file .h, funzioni aggiuntive
...
Come ultima cosa abbbiamo aggiunto delle funzioni non richieste che rendono la classe più completa (print, get_buffer_size, get_misure_count, get_Num_Lecture, get_Num_element).
